...
\begin{figure}[H]
	...
	\caption{Jerarquía de las imágenes de Docker desarrolladas}
\end{figure}
...
\label{docker-images-storm}
	...
	operación. En las siguientes secciones se mostrarán las imágenes de Docker
	creadas para cada uno de ellos y se comentará cual es el propósito de dicho
	nodo.
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\linewidth]{./informe/desarrollo/img/Cluster-Storm}
		\caption{Arquitectura básica de un clúster de Apache Storm\cite{Prakash2016}}
	\end{figure}
	...
	\label{docker-images-storm-nimbus}
		...
		monitorear el cluster buscando fallas y distribuir el código
		(\emph{topologías}) entre todos los nodos del cluster. Corre un proceso
	...
	\label{docker-images-storm-ui}
		...
		Ésta imágen de Docker es la encargada de levantar la interfaz gráfica de
		Apache Storm.
	...
	\subsection{Iniciar Apache Storm}
			...
			Finalizada la construcción de todas las imágenes anteriores, es posible
