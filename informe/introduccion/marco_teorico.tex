...
\label{section_docker}
	...
	\subsection{Imágenes y Contenedores\cite{GetStartedDocker2016}}
...
\end{lstlisting}
		...
		\begin{itemize}
		    ...
		    repositorio propiedad de Docker donde existen miles de imágenes disponibles.
...
\label{section_apache_zookeeper}
	...
	\subsection{El espacio de nombres y el modelo de datos}
		...
		lo cuales Zookeeper fue diseñado, los datos almacenados en cada nodo generalemente
...
\label{section_apache_storm}
	...
	código abierto y gratuita creada por Twitter y luego liberada bajo la órbita de
	...
	de datos por segundo por nodo. Provee características de escalabilidad, tolerancia a
	fallos, garantías de que todos los datos serán procesados, etcétera\cite{ApacheStorm097}.
	...
	\subsection{Conceptos Básicos}
		...
		\label{storm_topologies}
			...
			procesan y generan nuevos flujos de datos. Es el análogo a un trabajo de
			...
			través de \emph{Stream Groupings} (\ref{storm_stream_grouping}).
	...
	\subsection{Material}
		...
		La información de éste capítulo ha sido extraída mayormente desde la
		documentación de Apache Storm 1.0 \cite{ApacheStorm097}.
