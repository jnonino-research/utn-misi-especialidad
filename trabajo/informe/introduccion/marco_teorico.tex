...
\label{section_apache_storm}
	...
	de acuerdo a su documentación, es capaz de procesar un millón de tuplas de datos
	...
	\subsection{Conceptos Básicos}
		...
		\subsubsection{Topologies}
			...
			procesamiento de datos en tiempo real. Consume flujos de datos, los procesa y
			genera nuevos flujos de datos. Es el análogo a un trabajo de MapReduce de
