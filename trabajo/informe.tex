	...
	% INICIO DE LA PRIMERA PARTE. Resumen ejecutivo
 	...
 	%INICIO DEL TEXTO PRINCIPAL
 		...
 		% Desarrollo
 			\part{Desarrollo}
 				% Problema a Resolver
 					\input{./informe/desarrollo/problema_planteado}
 				% Diseño de la Arquitectura del Sistema
 					\input{./informe/desarrollo/arquitectura}
 				% Diseño Detallado/Implementación usando Apache Storm
 					\input{./informe/desarrollo/implementacion_storm}
 				% Diseño Detallado/Implementación usando Apache Spark
 					\input{./informe/desarrollo/implementacion_spark}
 				% Diseño Detallado/Implementación usando Apache Flink
					\input{./informe/desarrollo/implementacion_flink}
 		% Resultados y Conclusiones			
 			\part{Conclusiones}
 				% Conclusiones
 					\input{./informe/conclusiones/conclusiones}
 				% Trabajo futuro
 					\input{./informe/conclusiones/trabajo_futuro}	
	...
	% APENDICES
		...
		\part{Apéndices}
			...
			% Gestión de la metodología de desarrollo
				%\input{./informe/apendices/metodologia/metodologia}
